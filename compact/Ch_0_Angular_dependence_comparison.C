...
//=========  (Mon Mar 18 22:19:38 2024) by ROOT version 6.26/08
...
// ------------>Primitives in pad: p1
   ...
   Plot_comp__1->SetBinContent(3,45);
   Plot_comp__1->SetBinContent(4,48);
   Plot_comp__1->SetBinContent(5,49);
   Plot_comp__1->SetBinContent(6,45);
   Plot_comp__1->SetBinContent(7,40);
   Plot_comp__1->SetBinContent(8,37);
   Plot_comp__1->SetBinContent(9,33);
   Plot_comp__1->SetBinContent(10,28);
   Plot_comp__1->SetBinContent(11,25);
   Plot_comp__1->SetBinContent(12,22);
   Plot_comp__1->SetBinContent(13,18);
   Plot_comp__1->SetBinContent(14,16);
   Plot_comp__1->SetBinContent(15,13);
   ...
   Plot_comp__1->SetBinContent(25,13);
   Plot_comp__1->SetBinContent(26,14);
   Plot_comp__1->SetBinContent(27,17);
   Plot_comp__1->SetBinContent(28,17);
   Plot_comp__1->SetBinContent(29,19);
   Plot_comp__1->SetBinContent(30,20);
   Plot_comp__1->SetBinContent(31,23);
   Plot_comp__1->SetBinContent(32,27);
   Plot_comp__1->SetBinContent(33,28);
   ...
   Plot_comp__1->SetBinError(3,45);
   Plot_comp__1->SetBinError(4,48);
   Plot_comp__1->SetBinError(5,49);
   Plot_comp__1->SetBinError(6,45);
   Plot_comp__1->SetBinError(7,40);
   Plot_comp__1->SetBinError(8,37);
   Plot_comp__1->SetBinError(9,33);
   Plot_comp__1->SetBinError(10,28);
   Plot_comp__1->SetBinError(11,25);
   Plot_comp__1->SetBinError(12,22);
   Plot_comp__1->SetBinError(13,18);
   Plot_comp__1->SetBinError(14,16);
   Plot_comp__1->SetBinError(15,13);
   ...
   Plot_comp__1->SetBinError(25,13);
   Plot_comp__1->SetBinError(26,14);
   Plot_comp__1->SetBinError(27,17);
   Plot_comp__1->SetBinError(28,17);
   Plot_comp__1->SetBinError(29,19);
   Plot_comp__1->SetBinError(30,20);
   Plot_comp__1->SetBinError(31,23);
   Plot_comp__1->SetBinError(32,27);
   Plot_comp__1->SetBinError(33,28);
