...
void Wavelength_ana(int angle/*int num_evtsmax, const char* inputfilename*/) 
{
...
std::cout<<std::endl;
  ...
  else
  {
   ...
   //if(ievt==894){std::cout << "Problematic event " << ievt << " "<< ncerwavechan[0].size() << std::endl;}    
    ...
    string Entry_index_filter_pdf ="Plots/PbWO4/0811_100_ev/Angle_"+ entry_filter_string + "_deg/" + side_string + " SiPM " + title_string + " wavelength distribution for " + entry_filter_string + " deg.pdf";
